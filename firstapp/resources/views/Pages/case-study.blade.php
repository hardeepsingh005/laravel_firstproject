            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="wow fadeInUp" data-cursor="-opaque">Our case <span>study</span></h1>
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="case-study-item-image">
                            <a href="case-study-single.html" data-cursor-text="View">
                                <figure>
                                    <img src="{{url('assets/images/case-study-image-4.jpg')}}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Case Study Item Image End -->
                        ...
                        <div class="case-study-item-content">
                            ...
                            <h2><a href="case-study-single.html">Clinical Diagnostics Optimization</a></h2>
                        </div>
                        <!-- Case Study Item Contant End -->
                    </div>
                    <!-- Case Study Item Start -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="case-study-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="case-study-item-image">
                            <a href="case-study-single.html" data-cursor-text="View">
                                <figure>
                                    <img src="{{url('assets/images/case-study-image-5.jpg')}}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Case Study Item Image End -->
                        ...
                        <div class="case-study-item-content">
                            ...
                            <h2><a href="case-study-single.html">Pharmaceutical Quality Assurance</a></h2>
                        </div>
                        <!-- Case Study Item Contant End -->
                    </div>
                    <!-- Case Study Item Start -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="case-study-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <div class="case-study-item-image">
                            <a href="case-study-single.html" data-cursor-text="View">
                                <figure>
                                    <img src="{{url('assets/images/case-study-image-6.jpg')}}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Case Study Item Image End -->
                        ...
                        <div class="case-study-item-content">
                            ...
                            <h2><a href="case-study-single.html">Environmental Water Safety Test</a></h2>
                        </div>
                        <!-- Case Study Item Contant End -->
                    </div>
                    <!-- Case Study Item Start -->
